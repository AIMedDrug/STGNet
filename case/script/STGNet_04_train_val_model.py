...
for idx, kpii in enumerate(df):
    ...
    model_save_path = f'../results/pth/{curr_kpi}_model_weights.pth'
    ...
    savePath = f'../results/single/{curr_kpi}_Trainloss.csv'
    df = pd.DataFrame(trainLoss)
    df.to_csv(savePath, index=False)

    savePath = f'../results/single/{curr_kpi}_Valloss.csv'

...
def getProcessData(label, kpii):
    ...
    if label == 'train':
        allFoldPath = '../data/filterData/top5/{}/dataTrain.dat'.format(kpii)
    elif label == 'val':
        allFoldPath = '../data/filterData/top5/{}/dataVal.dat'.format(kpii)
    else:
        allFoldPath = '../data/filterData/top5/{}/dataTest.dat'.format(kpii)
...
if __name__ == '__main__':
    filePath = '../data/initial/tki.csv'
    kpi = pd.read_csv(filePath)['tki'].tolist()
    subPath = '../data/filterData/top5'
